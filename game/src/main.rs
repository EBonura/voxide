...
fn icon_tile(item: u8) -> u8 {
    match item {
        ...
        SEEDS => tex::T_I_SEEDS,
        BOW => tex::T_I_BOW,
        BUCKET => tex::T_I_BUCKET,
        WATER_BUCKET => tex::T_I_WATER_BUCKET,
        LAVA_BUCKET => tex::T_I_LAVA_BUCKET,
        TORCH => tex::T_I_TORCH,
        FLINT_STEEL => tex::T_I_FLINT,
        BOTTLE => tex::T_I_BOTTLE,
        POTION_AWKWARD => tex::T_I_POT_AWKWARD,
        POTION_SPEED => tex::T_I_POT_SPEED,
        POTION_STRENGTH => tex::T_I_POT_STRENGTH,
        POTION_REGEN => tex::T_I_POT_REGEN,
        POTION_FIRE => tex::T_I_POT_FIRE,
        BONEMEAL => tex::T_I_BONEMEAL,
        WIRE => tex::T_I_WIRE,
        SUGAR_CANE => tex::T_I_SUGAR_CANE,
        WHEAT_ITEM => tex::T_I_WHEAT,
        FISHING_ROD => tex::T_I_FISHING_ROD,
        EMBER_CAP => tex::T_I_EMBER_CAP,
        EMBER_ROD => tex::T_I_EMBER_ROD,
        WAILER_TEAR => tex::T_I_WAILER_TEAR,
        MAGMA_PASTE => tex::T_I_MAGMA_PASTE,
        VOID_PEARL => tex::T_I_VOID_PEARL,
        VOID_EYE => tex::T_I_VOID_EYE,
        FURNACE => tex::T_I_FURNACE,
        BED => tex::T_I_BED,
        PISTON => tex::T_I_PISTON,
        ENCHANT => tex::T_I_ENCHANT,
        FENCE => tex::T_I_FENCE,
        GLASS => tex::T_I_GLASS,
        SLAB => tex::T_I_SLAB,
